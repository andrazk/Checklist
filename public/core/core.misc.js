...
* CORE ONLINE
*/
core.online = navigator.onLine;
core.ononline = document.ononline = document.body.ononline = function(){
	if(core.socket.online) core.sync.sync();
	core.notify('online');
};

core.onoffline = document.onoffline = document.body.onoffline = function(){
	core.notify('offline');
};
document.body.addEventListener("offline",  core.onoffline, false);
document.body.addEventListener("online",  core.onoffline, false);